...
def draw_layer_b(x, y, shift):
	cx = Globs.camera_x >> shift
	cy = Globs.camera_y >> shift
...
def set_camera(camera_new_x, camera_new_y):
	...
	if Globs.layer_B_drawing_method == 0:
		...
		draw_layer_b(camera_new_x, camera_new_y, 4)
	elif Globs.layer_B_drawing_method == 2:
		draw_layer_b(camera_new_x, camera_new_y, 5)
